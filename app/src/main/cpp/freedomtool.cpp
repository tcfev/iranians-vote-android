...
Java_org_iranUnchained_utils_ZKPTools_CalcPublicBufferSize(JNIEnv *env, jobject thiz,
...
Java_org_iranUnchained_utils_ZKPTools_groth16_1prover(JNIEnv *env, jobject thiz,
                                                    jbyteArray zkey_buffer, jlong zkey_size,
...
extern "C"
JNIEXPORT jint JNICALL
Java_org_iranUnchained_utils_ZKPTools_passportVerification256(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_org_iranUnchained_utils_ZKPTools_passportVerification1(JNIEnv *env, jobject thiz,
                                                          jbyteArray circuit_buffer,
                                                          jlong circuit_size,
                                                          jbyteArray json_buffer,
                                                          jlong json_size, jbyteArray wtns_buffer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_org_iranUnchained_utils_ZKPTools_witnesscalcAuthV2(JNIEnv *env, jobject thiz,
                                                      jbyteArray circuit_buffer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_org_iranUnchained_utils_ZKPTools_credentialAtomicQueryMTPV2OnChainVoting(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jbyteArray circuit_buffer,
                                                                            jlong circuit_size,
                                                                            jbyteArray json_buffer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_org_iranUnchained_utils_ZKPTools_voteSMT(JNIEnv *env, jobject thiz, jbyteArray circuit_buffer,
                                            jlong circuit_size, jbyteArray json_buffer,
                                            jlong json_size, jbyteArray wtns_buffer,
                                            jlongArray wtns_size, jbyteArray error_msg,
                                            jlong error_msg_max_size) {
